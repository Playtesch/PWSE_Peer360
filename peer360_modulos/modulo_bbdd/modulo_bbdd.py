    ...
    for index, row in df_global.iterrows():
        ...
        if(not student_mail in registeredUsers):
            try:
                ...
                db.session.commit()
                send_email(student_mail,'Your teacher has requested you an evaluation, you have been granted a user. Please change the default password and submit your grade', \
